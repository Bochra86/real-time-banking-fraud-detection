...
from api.services.fraud_service import ( get_frauds, get_latest_frauds, highest_frauds as get_highest_frauds)
from api.services.analytics_service import ( get_statistics, frauds_by_city, daily_summary  )
...
@router.get("/frauds", 
            ...
            description="Returns fraud transactions with filtering, sorting and pagination.")
